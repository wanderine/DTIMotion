...
for s = 1:N
    ...
    % Load estimated motion parameters
    fid = fopen([basepath_FSL '/simulated_directions_with_small_rigid_motion_mcf.par']);
    text = textscan(fid,'%f%f%f%f%f%f');
    fclose(fid);
...
for s = 1:N
    ...
    % Load estimated motion parameters
    fid = fopen([basepath_AFNI '/simulated_directions_with_small_rigid_motion_motionparameters.1D']);
    text = textscan(fid,'%f%f%f%f%f%f');
    fclose(fid);
...
for s = 1:N
    ...
    % Load estimated motion parameters
    fid = fopen([basepath_BROCCOLI '/simulated_directions_with_small_rigid_motion_motionparameters.1D']);
    text = textscan(fid,'%f%f%f%f%f%f');
    fclose(fid);
...
mean(abs(FSL_translations_x_error))
mean(abs(AFNI_translations_x_error))
mean(abs(BROCCOLI_translations_x_error))

mean(abs(FSL_translations_y_error))
mean(abs(AFNI_translations_y_error))
mean(abs(BROCCOLI_translations_y_error))

mean(abs(FSL_translations_z_error))
mean(abs(AFNI_translations_z_error))
mean(abs(BROCCOLI_translations_z_error))

mean(abs(FSL_rotations_x_error))
mean(abs(AFNI_rotations_x_error))
mean(abs(BROCCOLI_rotations_x_error))

mean(abs(FSL_rotations_y_error))
mean(abs(AFNI_rotations_y_error))
mean(abs(BROCCOLI_rotations_y_error))

mean(abs(FSL_rotations_z_error))
mean(abs(AFNI_rotations_z_error))
mean(abs(BROCCOLI_rotations_z_error))
