...
for motion = 2:2
    ...
    if motion == 1
        filename = ['data/simulated_directions_with_large_rigid_motion.nii'];
    else
        filename = ['data/simulated_directions_with_small_rigid_motion.nii'];
    end
    save_untouch_nii(new_file,filename);
        
    if motion == 1
        filename=['data/simulated_directions_true_large_rigid_parameters'];
    else
        filename=['data/simulated_directions_true_small_rigid_parameters'];
    end
